...
<?php 
              ...
              <div class="proinfo" style="">
                ...
                <br>
                <br>
                <a href="brands-<?php echo $bid ?>">
                <h4>Brand: 
<?php $rowsxs =mysqli_query($con,"SELECT * FROM brands where id='$bid'  LIMIT 1" ) or die(mysqli_error($con)); while($rowxs=mysqli_fetch_array($rowsxs)){ echo $bname = $rowxs['name'];  } ?>
 </h4> </a>
                ...
                <button name="addcart" class="pbtn bgcolor" value="<?php echo $id ?>"> Add to Cart </button>
    ...
    <?php include 'include/brandscar.php'; ?>
