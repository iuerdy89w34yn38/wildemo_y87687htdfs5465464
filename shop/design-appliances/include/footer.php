...
<footer class="footer-v1">
  <div class="menuFooter clearfix bgcolor">
    <div class="container">
      <div class="row clearfix">
        ...
        <div class="col-sm-3 col-xs-12 borderLeft">
          <h5 class="theme-text">Quick Links</h5>
          <ul class="menuLink">
            <?php

            $rows =mysqli_query($con,"SELECT name,slug,res FROM pages where res=1 AND hide=0  ORDER BY ordr" ) or die(mysqli_error($con));
            ...
            while($row=mysqli_fetch_array($rows)){
              ...
              ?>
              <li <?php if($slug=='videos') echo ' style="display:none;" ' ; ?> ><a class="theme-text" href="<?php echo $slug ?>"><?php echo $name ?></a></li>
            <?php } ?>
 ...
 <div class="footer clearfix bgcolor bgdark">
  <div class="container">
    <div class="row clearfix">
      <div class="col-sm-6 col-xs-12 copyRight">
        <p>© 2019 Copyright Company Pvt Ltd. </p>
