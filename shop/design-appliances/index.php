...
<body class="body-wrapper">
  ...
  <div class="main_wrapper">
    ...
    <div class="count clearfix wow fadeIn paralax" data-wow-delay="100ms" style="background-image: url(images/<?php // echo $vidimg ?>);">
      ...
      <div class="paralax-text text-center" style=" padding: 20px; margin-top: 0px;margin-bottom: 0px;">
            ...
            <div class="item col-md-4 ">
              <div class="item-inner">
                <div class="project-item">
                  <div class="img-holder img-holder-9" style="background:url(images/products/<?php echo $img ?>);     background-position: top;    background-size: contain;    background-repeat: no-repeat"></div>
                   <?php if(!empty($sale)){ ?><div class="bgcolor icn"><?php $saleper = (($price/$saleprice)*100)-100; echo round($saleper)  ?>%</div> <?php } ?>
                  <div class="info-mask">
                    <div class="mask-inner">
                      <h6 style="font-size: 13px"><?php echo $name ?>
                        <br>
                        <span style="font-size: 13px">Rs. <?php echo number_format($price) ?>/ <?php if(!empty($sale)){ ?> <t class="und txtcolor">Rs.  <?php echo number_format($saleprice) ?>/-</t> <?php } ?></span>
                      </h6>
